...
def UEfficientNet(input_shape=(None,None,3),dropout_rate=0.1):
    ...
    start_neurons=8
    backbone=efn.EfficientNetB7(input_shape=(256,256, 3),weights='imagenet',include_top=False)
    input=backbone.input

    conv4 = backbone.layers[800].output
    ...
    conv3 = backbone.layers[459].output
    ...
    conv2 = backbone.layers[208].output
    ...
    conv1 = backbone.layers[109].output
    ...
    output_layer = k.Conv2D(10, (1, 1), padding="same", activation=None)(uconv0)
