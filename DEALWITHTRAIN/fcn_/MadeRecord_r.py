...
def parse_example(serialized_example):
    ...
    variable=tf.constant([256],dtype=tf.float32)
    float_image = tf.divide(images,variable)
    ...
    print(float_image.shape,label.shape)
...
if __name__ == '__main__':
    ...
    jpg_dir="C:/Users/86188/PycharmProjects/MAP/glacier/data/save_jpg"
    label_dir="C:/Users/86188/PycharmProjects/MAP/glacier/data/save_label"
